...
class LoadingMeditationView extends StatelessWidget {
  ...
  Future<http.Response> generateMeditation() async {
    ...
    // print('[Response] ${(await restOperation.response).body}');
    ...
    print("Waiting por meditation to be generated");
    Future<http.Response> request = http.get(Uri.parse(
        'https://188s5h8465.execute-api.us-east-1.amazonaws.com/dev/randomize?time=${config.time}'))
      ..then((value) => print("Request: $value"));
